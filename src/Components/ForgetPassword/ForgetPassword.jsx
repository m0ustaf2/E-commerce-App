        ...
        <div className="w-75 mx-auto py-4 my-5">
         ...
         {flagData ?
          <form onSubmit={formik2.handleSubmit}>
            ...
            <input onBlur={formik2.handleBlur} placeholder='Enter verification code' className='form-control mb-2' onChange={formik2.handleChange} value={formik2.values.resetCode} type="text" name='resetCode' id='resetCode' />
            ...
            <button disabled={!(formik2.isValid && formik2.dirty && !isloading)} type='submit' className='btn bg-main text-white' >
              {!isloading?"Verify Code":<i className='fas fa-spinner fa-spin'></i>}
            </button>
          </form>:
          <form onSubmit={formik.handleSubmit}>
            <p>Please enter your email address. you will receive a verification code..</p>
            <label htmlFor="email">Email : </label>
            <input onBlur={formik.handleBlur} placeholder='Enter email' className='form-control mb-2' onChange={formik.handleChange} value={formik.values.email} type="email" name='email' id='email' />
