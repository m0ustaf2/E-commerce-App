...
export default function ProductDetailes() {
  ...
  async function getProductDtls(id) {
    try {
      setisLoading(true);
          ...
          <>
            <div className="col-md-3 sldr">
              <Slider {...settings} autoplay autoplaySpeed={3000}>
                {productdtls.images?.map((ele, index) => (
                  <img
                    key={index}
                    className="w-100"
                    alt={productdtls.title}
                    src={ele}
                  />
                ))}
              </Slider>
            ...
            <div className="col-md-9  d-flex justify-content-center flex-column dtl">
              ...
              <span className='me-auto'>{productdtls?.category?.name}</span>
              <div className="d-flex justify-content-between mt-4">
                <span className="me-auto">
                  {productdtls?.priceAfterDiscount ? (
                    <>
